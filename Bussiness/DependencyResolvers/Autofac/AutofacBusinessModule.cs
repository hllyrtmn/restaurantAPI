...
namespace Business.DependencyResolvers.Autofac
{
    public class AutofacBusinessModule : Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<EfRestaurantOpinionDal>().As<IRestaurantOpinionDal>().SingleInstance();
            builder.RegisterType<RestaurantOpinionManager>().As<IRestaurantOpinionService>().SingleInstance();
